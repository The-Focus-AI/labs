...
When I'm coding, I'm in a harness. When I'm reading a PDF I needed to read anyway, the harness is the thing reading it. Operations folder — SOWs, invoices, content ideas, project status — that's a harness. Parsing 20 financial deal docs and writing me a summary while I sleep — harness. *Family infographics, fasting tracker, [oura ring trends](/dispatch/how-ai-january-2026/) — harness, harness, harness.* Different work, same unit.
